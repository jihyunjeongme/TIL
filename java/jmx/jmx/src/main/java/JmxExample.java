...
public class JmxExample implements Runnable { public void run() {
    try {
    ...
    public static void main(String[] args) throws InterruptedException { JmxExample runnable = new JmxExample();
        while (true) {
